...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='aspirator-spalare';
...
const PICK=['DQ5L903BM','D8VDZL3BM','D0FY7L3BM','DXZPJYBBM','DKFKXK2BM','DC14XQ3BM','DLM9YWYBM','DTT4XK2BM'];
