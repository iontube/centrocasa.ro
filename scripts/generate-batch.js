...
async function generateArticleContent(keyword, category) {
  ...
  const prompt = `Esti un expert in amenajari interioare, mobilier si produse pentru casa care scrie pe un blog romanesc. Scrii intr-un stil direct, conversational, ca un prieten care se pricepe si iti da sfaturi concrete. NU esti un AI. Esti un om real cu experienta reala.
  ...
  <article class="article-container">
    ...
    <header class="article-header">
      <div class="article-meta">
        ...
        <span class="article-date">${new Date(date).toLocaleDateString('ro-RO', { year: 'numeric', month: 'long', day: 'numeric' })}</span>
      </div>
