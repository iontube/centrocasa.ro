...
/**
 * Auto-generate articles script for centrocasa.ro
...
// Config - 1 article per run for centrocasa.ro
...
async function main() {
  await log('='.repeat(60));
  await log('AUTO-GENERATE STARTED - centrocasa.ro');
  await log('='.repeat(60));
  ...
  const projectName = process.env.CLOUDFLARE_PROJECT_NAME || 'centrocasa-ro';
