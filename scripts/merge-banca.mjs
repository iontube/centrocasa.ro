...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='banca-gradina';
...
const PICK=['D4MKJ4YBM','D5KTLWMBM','D7BP8NMBM','D5MY5T3BM','DL7PCKYBM','D8M59VYBM','DHSY7GBBM','DG2V0LBBM','D6WBVBMBM'];
