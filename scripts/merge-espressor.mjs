...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='espressor-automat';
...
const PICK=['DPMX5RYBM','DXJ8K1BBM','D9P7PCBBM','DTGV4MBBM','D2PXSMYBM','DNSR7HYBM','DWR2QZ3BM','DP3NZ2YBM','DK6WBXMBM'];
