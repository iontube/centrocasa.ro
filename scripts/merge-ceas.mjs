...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='ceas-decorativ';
...
const PICK=['DR1QPRMBM','DJ0CF7BBM','D02MBZMBM','DKWFGPYBM','DHNWCZMBM','DVSV5XYBM','DWRGG9MBM','DHRGG9MBM','DBM08TYBM','DRJH64YBM'];
