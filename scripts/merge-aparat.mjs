...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='aparat-abur';
...
const PICK=['DPS6622BM','D54CNTYBM','DYRZBL3BM','DRVJNHMBM','D2SVCPYBM','DNBVS9BBM','DS4CNTYBM','DHHFFNYBM','DN7L18YBM','DHH9RFYBM','DSN602YBM','DMN573MBM'];
