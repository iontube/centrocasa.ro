...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='lampadar-colt';
...
const PICK=['DK6RCD2BM','D4RD0K2BM','D8QJ983BM','DDSMMNYBM','DRGHPH3BM','DKY0LSYBM','DP2ZW7MBM','DNCFB33BM'];
