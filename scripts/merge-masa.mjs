...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='masa-pliabila';
...
const PICK=['DKRD4YMBM','DMZLM2MBM','DX37RHYBM','DJ08FYMBM','DD5MQCMBM','DLP0FSYBM','D75MQCMBM','D2DXTH3BM','DTDXTH3BM'];
