...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='masina-spalat-vase';
...
const PICK=['DQ7CXWBBM','DZ5HNXMBM','DRSSHQBBM','DCFT3TYBM','D29MY5YBM','D5VVPDMBM','D54VMDMBM','D1VVPDMBM','DLWK52BBM','D4V772MBM','D4BX13MBM'];
...
list.forEach((r,i)=>console.log((i+1)+'. rev='+r.reviews+' rat='+r.rating+' '+r.price+'lei | '+r.name.replace(/\s+/g,' ').slice(0,46)));
