...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='pergola-lemn';
...
const PICK=['DVTRQN3BM','DHDL2M3BM','DZ2L2M3BM','DH6YPN2BM','D223PN2BM','D6DWZ73BM','DFFYPN2BM','D3H3PN2BM'];
