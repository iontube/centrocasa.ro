...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='covor-living';
...
const PICK=['DWR5DTYBM','D4YBN3MBM','DQTYDJBBM','DVLMDJBBM','DLKXV8MBM','D6TJTRBBM','DH4WBQYBM','D4RJW9BBM','D4W3FVYBM','DD6QD2MBM','DWYT5VMBM','DQFC6KBBM'];
