...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='sezlong-plaja';
...
const PICK=['DHYNB0MBM','D3TRBFYBM','DYJFKNMBM','D4FN7LYBM','DQ8L23MBM','D6786XYBM','DN1TYSMBM','D5B6ZD3BM'];
...
list.forEach((r,i)=>console.log((i+1)+'. rev='+r.reviews+' rat='+r.rating+' '+r.price+'lei | '+r.name.replace(/\s+/g,' ').slice(0,48)));
