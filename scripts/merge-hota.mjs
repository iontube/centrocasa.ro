...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='hota-puternica';
...
const PICK=['D4M2SHYBM','DTH9CLBBM','DK4SLN3BM','D06C7LMBM','DNQ0PF3BM','DPRT4LBBM','DWT6LZYBM','D2K6LZYBM','D76C7LMBM','D9ZPL83BM','DWV138BBM','DLMRR3BBM'];
