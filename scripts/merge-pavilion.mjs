...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='pavilion-gradina';
...
const PICK=['D6LW5KMBM','DDDYTN2BM','DM56L8MBM','DN4TR6MBM','D182ZM2BM','DQP7KSBBM','D1QQN8MBM','DY630JMBM','DQWGRWMBM'];
