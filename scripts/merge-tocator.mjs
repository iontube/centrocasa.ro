...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='tocator-crengi';
...
const PICK=['D1H2QXMBM','DD1MSMMBM','D0NWHG3BM','D57KN3MBM','DXLZT8BBM','DHY097MBM','D54MM7BBM','DBRZRLMBM','D9TTJMBBM','DNYKFDMBM','DZPBXGMBM','DYNNNVYBM'];
