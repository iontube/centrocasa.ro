...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='balansoar-2-persoane';
...
const PICK=['DVGL9Q3BM','DNSV7K2BM','DBYTDSYBM','D3YTDSYBM','D4WQPLYBM','DV6VZSYBM','DJ6VZSYBM','D628LB2BM','D4WZ7JYBM'];
...
list.forEach((r,i)=>console.log((i+1)+'. rev='+r.reviews+' rat='+r.rating+' '+r.price+'lei | '+r.name.replace(/\s+/g,' ').slice(0,52)));
