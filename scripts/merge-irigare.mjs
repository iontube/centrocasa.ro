...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='sistem-irigare';
...
const PICK=['DY2ZY5MBM','DLFCZBYBM','DYP4RWMBM','DYP777YBM','D313PCYBM','DHHW6X3BM','DRZRSCYBM','DP3BMSYBM','D9P1KXYBM','D2MN6NMBM','DLVQKMMBM','D9H46YBBM'];
