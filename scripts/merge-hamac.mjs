...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='hamace';
...
const PICK=['D4SKYVBBM','DXDW9XYBM','DFTGC4MBM','DWZQPD2BM','DGPGX2MBM','D3P4D5BBM','DTB8XYMBM','DP421FBBM'];
