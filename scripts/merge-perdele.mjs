...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='perdele-blackout';
...
const PICK=['D25VBZMBM','DQXH7ZMBM','D9L514YBM','D56WJT2BM','DM5MT5MBM','DL9Z0W3BM','DJ8YM13BM','D3BNY02BM','DLFR31YBM'];
