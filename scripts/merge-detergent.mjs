...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='detergent-eco';
...
const PICK=['DLJPBMBBM','DCDJFPMBM','DGSCKM2BM','DMG4M0BBM','DYNSK5BBM','D3FMHK3BM','D4HNT3MBM','D7JWDL3BM','DW9XFKYBM'];
