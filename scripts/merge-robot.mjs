...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='robot-bucatarie-multi';
...
const PICK=['DP438JBBM','DKZG86BBM','D0191M2BM','D86TJYBBM','DZ1KJYBBM','DTBD373BM','DGJK5KBBM','D3PJ32BBM','D5MG0ZBBM'];
