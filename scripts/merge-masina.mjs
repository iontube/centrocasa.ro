...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='masina-electrica-gazon';
...
const PICK=['D4CG9JYBM','DB6W5HYBM','DB873KMBM','D34RVGYBM','D74RVGYBM','DTNQBPYBM','DC10DZBBM','DZ10DZBBM','DJXDVGYBM','DS1MSMMBM','DTLX6JMBM','D1WKWDMBM'];
