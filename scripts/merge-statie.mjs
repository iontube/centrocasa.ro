...
const NO_IMG=process.argv.includes('--no-img'); const GROUP='statie-abur';
...
const PICK=['D3FY22MBM','DP8PMLBBM','DJK18DMBM','DQM4V6MBM','DDXMVVMBM','DV9Y22MBM','D7BFC2MBM','DQMP7MYBM','DSL830BBM','D5MP7MYBM','DN0WBFYBM','D0B4LXMBM'];
